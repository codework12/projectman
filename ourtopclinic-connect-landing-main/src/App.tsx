      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/app/doctor/pending-approval" element={<PendingApproval />} />
            <Route path="/admin/dashboard" element={<AdminDashboard />} />
            <Route path="/app/doctor" element={<AppDoctor />} />
            <Route path="/app/doctor/profile" element={<DoctorProfile />} />
            <Route path="/app/doctor/appointments" element={<AppointmentSchedule />} />
            ...
            <Route path="/app/patient/appointments" element={<AppointmentSchedule />} />
