          ...
          <div className="relative z-10 py-16 px-8 md:px-16 text-white">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6 reveal scroll-animation-3">
                <Button 
                  size="lg" 
                  className="bg-white text-clinic-500 hover:bg-gray-100 hover:text-clinic-700 group"
                >
                  Join Now
                ...
                <Button 
                  size="lg" 
                  variant="outline" 
                  className="text-white border-white hover:bg-white hover:text-clinic-500 group"
                >
